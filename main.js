...
let isValid = BIP39.validateMnemonic("Enter your mnemonic here");
...
function deriveEthAddress(pubKey){
  // Taking the keccak-256 hash of the public key will return 32 bytes which you need to trim down to the 
  //last 20 bytes (40 characters in hex) to get the address
